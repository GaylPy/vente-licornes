(function () {
    ...
    var modalService = function ($modal) {
        ...
        var modalDefaults = {
            ...
            keyboard: true,
            modalFade: true,
            templateUrl: '/app/licornesApp/partials/modal.html'
        };
        ...
        var modalOptions = {
            ...
            actionButtonText: 'OK',
            headerText: 'Accepter?',
            bodyText: 'Vous vous vraiment éxecuter cette action?'
        };
    ...
    angular.module('licornesApp').service('modalService', modalService);
